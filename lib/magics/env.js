...
decorateMagic(
    ...
    [
        "description",
        "%env: lists all environment variables/values %env var: get value for var %env var val: set value for var %env var=val: set value for var %env var={val}: set value for var.",
        {
            "variable": "The environment variable to show or set",
            "=value": "The value to assign to the environment variable. e.g. `%env HOME=/tmp`",
        },
    ],
);
