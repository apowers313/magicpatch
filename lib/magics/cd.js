...
function cd() {
    let {last, number: histNum, quiet, args: dirs} = this.args;
...
decorateMagic(
    ...
    ["option", "-n,--number <histNum>", "Changes to the n-th directory in the directory history", $$.addMagic.utils.numberParser.bind(null, "%cd")],
